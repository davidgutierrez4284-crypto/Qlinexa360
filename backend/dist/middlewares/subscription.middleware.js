...
exports.blockWriteOperationsIfCancelled = exports.subscriptionAccess = void 0;
const database_1 = __importDefault(require("../config/database"));
const error_utils_1 = require("../utils/error.utils");
const subscriptionAccess = (mode) => async (req, res, next) => {
    if (!req.user)
    ...
    const subscriptionStatus = ((subscription === null || subscription === void 0 ? void 0 : subscription.status) || 'none').toUpperCase();
    const now = new Date();
...
exports.subscriptionAccess = subscriptionAccess;
// Middleware para bloquear todas las operaciones de escritura cuando la suscripción está cancelada
const blockWriteOperationsIfCancelled = async (req, res, next) => {
...
exports.blockWriteOperationsIfCancelled = blockWriteOperationsIfCancelled;
