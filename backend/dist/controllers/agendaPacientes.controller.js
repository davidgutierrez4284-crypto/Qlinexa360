...
exports.AgendaPacientesController = void 0;
...
class AgendaPacientesController {
    // Obtener configuración de agenda del doctor
    static async getAgendaConfig(req, res) {
        var _a;
        try {
            ...
            let linkToReturn = (agendaConfig === null || agendaConfig === void 0 ? void 0 : agendaConfig.link) || null;
    ...
    static async updateAgendaConfig(req, res) {
        var _a;
        try {
            if (!((_a = req.user) === null || _a === void 0 ? void 0 : _a.userId)) {
                return res.status(401).json({ error: 'No autorizado' });
        ...
        try {
            ...
            if (fecha) {
                ...
                if (dateParts.length === 3) {
                    ...
                    targetDate = new Date(parseInt(dateParts[0]), parseInt(dateParts[1]) - 1, // Los meses son 0-indexed
            ...
            const appointmentDuration = (scheduleConfig === null || scheduleConfig === void 0 ? void 0 : scheduleConfig.appointmentDuration) || 30; // minutos
            const bufferTime = (scheduleConfig === null || scheduleConfig === void 0 ? void 0 : scheduleConfig.bufferTime) || 15; // minutos
            // Generar slots en la zona horaria del doctor (evita desfase 9am→3am)
            const doctorTimezone = (_b = (_a = agendaConfig.Doctor) === null || _a === void 0 ? void 0 : _a.timezone) !== null && _b !== void 0 ? _b : 'America/Mexico_City';
            ...
            const formatSlotInTimezone = (d, tz) => {
    ...
    static async createAppointment(req, res) {
        ...
        try {
            ...
            if (slotIdMatch === null || slotIdMatch === void 0 ? void 0 : slotIdMatch[1]) {
            ...
            const scheduleConfig = await schedule_service_1.ScheduleService.getScheduleConfig(agendaConfig.doctor_id);
            const appointmentDuration = (_a = scheduleConfig === null || scheduleConfig === void 0 ? void 0 : scheduleConfig.appointmentDuration) !== null && _a !== void 0 ? _a : 30;
            ...
            const doctorTimezone = (_c = (_b = agendaConfig.Doctor) === null || _b === void 0 ? void 0 : _b.timezone) !== null && _c !== void 0 ? _c : 'America/Mexico_City';
            const isSlotAvailable = await schedule_service_1.ScheduleService.isTimeSlotAvailable(agendaConfig.doctor_id, slotTime, doctorTimezone);
            if (!isSlotAvailable) {
            ...
            const appointmentData = {
                ...
                date: slotTime,
                time: `${(0, date_utils_1.formatAppointmentTimeWithAmPm)(slotTime, doctorTimezone)} - ${(0, date_utils_1.formatAppointmentTimeWithAmPm)(slotEnd, doctorTimezone)}`,
            ...
            const doctorNotifications = await notification_service_1.NotificationService.sendDoctorNotification('doctor@example.com', // TODO: Obtener email del doctor desde la relación User
    ...
    static async sendLinkToPatients(req, res) {
        ...
        try {
            ...
            for (const patient of patients) {
                if (!((_b = patient.user) === null || _b === void 0 ? void 0 : _b.email)) {
                    results.push({
                        patientId: patient.id,
                        patientName: `${((_c = patient.user) === null || _c === void 0 ? void 0 : _c.firstName) || ''} ${((_d = patient.user) === null || _d === void 0 ? void 0 : _d.lastName) || ''}`,
                        email: ((_e = patient.user) === null || _e === void 0 ? void 0 : _e.email) || 'N/A',
                        success: false,
              ...
              <div style="max-width: 600px; margin: 0 auto; padding: 20px; background-color: #ffffff;">
                ...
                <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #e5e7eb; text-align: center;">
                  ...
                  <p style="font-size: 11px; color: #999; margin: 5px 0 0 0;">
                    ...
                    const emailSent = await (0, email_utils_1.sendEmailHtml)(patient.user.email, subject, html, email_utils_1.fromAddresses.noReply);
                    results.push({
                        patientId: patient.id,
                    ...
                    results.push({
                        patientId: patient.id,
                        patientName: `${((_f = patient.user) === null || _f === void 0 ? void 0 : _f.firstName) || ''} ${((_g = patient.user) === null || _g === void 0 ? void 0 : _g.lastName) || ''}`,
                        email: ((_h = patient.user) === null || _h === void 0 ? void 0 : _h.email) || 'N/A',
                        success: false,
...
exports.AgendaPacientesController = AgendaPacientesController;
