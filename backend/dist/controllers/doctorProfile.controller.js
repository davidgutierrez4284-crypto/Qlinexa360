...
class DoctorProfileController {
    ...
    static async updateProfileConfig(req, res) {
        ...
        try {
            ...
            const { consultorioDireccion, consultorioTelefono, certificadoProfesional, certificadoEspecialidad, certificadoMaestria, universidad, primaryColor, secondaryColor, socialMediaFacebook, socialMediaInstagram, socialMediaX, socialMediaOther, timezone } = req.body;
