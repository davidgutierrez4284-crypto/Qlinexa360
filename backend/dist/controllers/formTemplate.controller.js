...
exports.getFormTemplates = void 0;
...
const getFormTemplates = async (req, res) => {
    try {
        ...
        const templates = await database_1.default.formTemplate.findMany({
            include: {
                fields: {
                    orderBy: {
        ...
        const sortedTemplates = templates.sort((a, b) => {
            var _a, _b;
            const orderA = (_a = displayOrder[a.name]) !== null && _a !== void 0 ? _a : 999;
            const orderB = (_b = displayOrder[b.name]) !== null && _b !== void 0 ? _b : 999;
            if (orderA !== orderB) {
        ...
        const handledError = error instanceof error_utils_1.AppError ? error : new error_utils_1.AppError('Error interno al obtener las plantillas.', 500);
