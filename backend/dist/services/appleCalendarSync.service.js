...
exports.AppleCalendarSyncService = void 0;
...
class AppleCalendarSyncService {
    static parseCredentials(config) {
        ...
        try {
            ...
            if ((parsed === null || parsed === void 0 ? void 0 : parsed.username) && (parsed === null || parsed === void 0 ? void 0 : parsed.password)) {
                return {
    ...
    static async ensureValidConfig(doctorId) {
        var _a;
        ...
        try {
            ...
            const calendar = (_a = calendars.find(cal => cal.url === credentials.calendarUrl)) !== null && _a !== void 0 ? _a : calendars[0];
    ...
    static buildICalString(payload, filename) {
    ...
    static extractEvent(icsData) {
        const parsed = (0, node_ical_1.parseICS)(icsData);
        const event = Object.values(parsed).find(value => value.type === 'VEVENT');
    ...
    static async upsertEvent(doctorId, payload) {
        ...
        try {
            const filename = payload.externalEventId
                ...
                : `${payload.id || crypto_1.default.randomUUID()}.ics`;
            const client = await (0, tsdav_1.createDAVClient)({
                serverUrl: APPLE_SERVER_URL,
                credentials: {
    ...
    static async getEvent(doctorId, externalEventId) {
        ...
        try {
            ...
            if (!(object === null || object === void 0 ? void 0 : object.data)) {
                return null;
            }
            // Parsear el iCal para obtener información del evento y attendees
            const parsed = (0, node_ical_1.parseICS)(object.data);
            const event = Object.values(parsed).find(value => value.type === 'VEVENT');
            if (!event) {
                return null;
            }
    ...
    static async syncCalendar(doctorId) {
        const context = await AppleCalendarSyncService.ensureValidConfig(doctorId);
        if (!context) {
            ...
            for (const object of objects) {
                ...
                if (existing) {
                    ...
                    await prisma.internalCalendarEvent.create({
                        data: Object.assign({ doctorId, creadoPor: doctorId }, payload)
                    });
                    created += 1;
                }
            }
...
exports.AppleCalendarSyncService = AppleCalendarSyncService;
