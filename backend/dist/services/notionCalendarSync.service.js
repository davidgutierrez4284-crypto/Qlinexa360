...
class NotionCalendarSyncService {
    static parseCredentials(config) {
        ...
        try {
            ...
            try {
                ...
                if ((parsed === null || parsed === void 0 ? void 0 : parsed.accessToken) && (parsed === null || parsed === void 0 ? void 0 : parsed.databaseId)) {
                    return {
    ...
    static async ensureValidCredentials(config) {
        ...
        if (config.expiresAt &&
            ...
            config.refreshToken) {
            const refreshed = await oauth_service_1.OAuthService.refreshAccessToken('notion', config.refreshToken);
    ...
    static buildNotionPageProperties(payload, databaseId) {
        const properties = {
            Name: {
                title: [
                    {
    ...
    static async upsertEvent(doctorId, payload) {
        ...
        if (!databaseId) {
            ...
            try {
                ...
                const calendarDatabase = databases.find((db) => {
                    var _a, _b, _c, _d, _e, _f;
                    return ((_c = (_b = (_a = db.title) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.plain_text) === null || _c === void 0 ? void 0 : _c.toLowerCase().includes('calendario')) ||
                        ((_f = (_e = (_d = db.title) === null || _d === void 0 ? void 0 : _d[0]) === null || _e === void 0 ? void 0 : _e.plain_text) === null || _f === void 0 ? void 0 : _f.toLowerCase().includes('calendar'));
                });
                if (calendarDatabase) {
        ...
        try {
            const properties = NotionCalendarSyncService.buildNotionPageProperties(payload, databaseId);
            let pageId;
            if (payload.externalEventId) {
                ...
                try {
                    ...
                    if ((error === null || error === void 0 ? void 0 : error.code) === 'object_not_found') {
    ...
    static async deleteEvent(doctorId, externalEventId) {
        ...
        try {
            ...
            const status = error === null || error === void 0 ? void 0 : error.code;
    ...
    static async syncCalendar(doctorId, config) {
        ...
        try {
            ...
            for (const page of pages) {
                ...
                const title = ((_b = (_a = nameProp === null || nameProp === void 0 ? void 0 : nameProp.title) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.plain_text) || 'Sin título';
                const startDate = ((_c = startProp === null || startProp === void 0 ? void 0 : startProp.date) === null || _c === void 0 ? void 0 : _c.start)
                    ? new Date(startProp.date.start)
                    : null;
                const endDate = ((_d = endProp === null || endProp === void 0 ? void 0 : endProp.date) === null || _d === void 0 ? void 0 : _d.start)
                    ? new Date(endProp.date.start)
                    : null;
                const description = ((_f = (_e = descProp === null || descProp === void 0 ? void 0 : descProp.rich_text) === null || _e === void 0 ? void 0 : _e[0]) === null || _f === void 0 ? void 0 : _f.plain_text) || null;
                const location = ((_h = (_g = locationProp === null || locationProp === void 0 ? void 0 : locationProp.rich_text) === null || _g === void 0 ? void 0 : _g[0]) === null || _h === void 0 ? void 0 : _h.plain_text) || null;
                const linkMeeting = (linkProp === null || linkProp === void 0 ? void 0 : linkProp.url) || null;
...
exports.NotionCalendarSyncService = NotionCalendarSyncService;
