...
export const env = {
  ...
  MERCADOPAGO_AUTH_BASE_URL:
    process.env.MERCADOPAGO_AUTH_BASE_URL || 'https://auth.mercadopago.com.mx',
  MERCADOPAGO_ENV: (process.env.MERCADOPAGO_ENV || 'sandbox') as 'sandbox' | 'production',
  QLINEXA360_MARKETPLACE_FEE_PERCENTAGE: parseFloat(
    process.env.QLINEXA360_MARKETPLACE_FEE_PERCENTAGE || '1'
  ),
}; 