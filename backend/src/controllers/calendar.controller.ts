      ...
      events.map(async (event) => {
        ...
        if (event.patientId) {
          ...
          if (appointment) {
            ...
            // NO consultar Google/Outlook/Apple aquí: en listados con N citas eso dispara
            // N llamadas externas y hace timeout el frontend (toasts repetidos).
            // La aceptación/rechazo del paciente se actualiza en sync periódico / webhooks.
