...
async function checkPatientData() {
  try {
    ...
    clinicalCases.forEach((case_, index) => {
      ...
      console.log(`Doctor: ${case_.doctor.user.firstName} ${case_.doctor.user.lastName}`);
    ...
    consultations.forEach((consultation, index) => {
      ...
      console.log(`Doctor: ${consultation.doctor?.user?.firstName || 'N/A'} ${consultation.doctor?.user?.lastName || 'N/A'}`);
      console.log(`Caso clínico: ${consultation.clinicalCase?.padecimiento || 'Sin caso clínico'}`);
